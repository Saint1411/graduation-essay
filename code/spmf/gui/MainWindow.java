...
public class MainWindow extends JFrame implements ThreadCompleteListener, UncaughtExceptionHandler {
	...
	/** he current data mining process */
	...
	public MainWindow(boolean showTools, boolean showAlgorithms) {
		...
		buttonRun.setBounds(301, 452, 119, 23);
...
//				openWebPage("http://www.philippe-fournier-viger.com/spmf/");
		...
		scrollPane.setBounds(10, 513, 683, 194);
		...
		checkboxOpenOutputText = new JRadioButton("Text editor");
		...
		checkboxOpenOutputText.setBounds(44, 351, 108, 23);
		...
		checkboxOpenOutputPatternViewer.setBounds(159, 348, 125, 29);
		...
		progressBar.setBounds(277, 486, 163, 16);
		...
		checkboxOpenOutputTimeSeriesViewer.setBounds(300, 348, 140, 29);
		...
		checkboxClusterViewer.setBounds(461, 348, 131, 29);
		...
		lblOptions = new JLabel("Other options:");
		lblOptions.setBounds(22, 384, 140, 14);
		...
		chckbxRunAsExternal.setBounds(44, 403, 182, 23);
		...
		textMaxSeconds.setBounds(347, 404, 56, 20);
		...
		chckbxMaxSeconds.setBounds(233, 403, 108, 23);
...
//					clusterViewer.runAlgorithm(new String[]{separator}, outputFile, null);
	...
	private void processRunAlgorithmCommandFromGUI() {
		...
		// If the user set a max time limit, we launch a thread to monitor and kill the process
