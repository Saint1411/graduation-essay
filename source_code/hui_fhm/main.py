...
class FHMAlgo:
    ...
    def print_result(self, output_file=False):
...
if __name__ == "__main__":
    min_utility = 6000
    input_file = "D:\personal\graduation-essay\source_code\datasets\chainstore_of_high_ultility_itemset.txt"
    output_file = "output_fhm.txt"
    print("****DOING****")
    algo = FHMAlgo(min_utility)
